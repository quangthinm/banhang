	            ...
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                    <div class="table-responsive">
		                    ...
		                    @endif
	                    	<form class="form-horizontal" action="admin/sanpham/them" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
								  	...
								  	<div class="col-md-10">
								  		<input id="ProductName" name="ProductName" type="text" placeholder="Tên sản phẩm" class="form-control input-md">
								  	</div>
								</div>
								<!-- Text input-->
								<div class="form-group">
								  	...
								  	<div class="col-md-10">
								  		<input id="ProductSlug" name="ProductSlug" type="text" placeholder="Slug" class="form-control input-md">   
							 	 	</div>
								</div>
								<!-- Text input-->
								<div class="form-group">
								  	<label class="col-md-2 control-label" for="ProductPrice">
								  		Giá sản phẩm								  	</label>  
								  	<div class="col-md-10">
								  		<input id="ProductPrice" name="ProductPrice" type="number" placeholder="Giá sản phẩn" class="form-control input-md">									    
								  	</div>
								</div>
								<!-- Text input-->
								<div class="form-group">
								  	...
								  	<div class="col-md-10">
									    <select id="ProductCate" name="ProductCate" class="form-control">
									    	...
									    	@foreach($danhmucsanpham as $dmsp)
									      		<option value="{{$dmsp->id}}">{{$dmsp->CategoryName}}</option>
									      	@endforeach
									    </select>
								  	</div>
								</div>
									    ...
									    <select id="ProductSubCate" name="ProductSubCate" class="form-control">
									    	<option value="0">--Chọn danh mục con--</option>
									      	@foreach($danhmuccon as $dmc)
									      		<option value="{{$dmc->id}}">{{$dmc->sub_name}}</option>
									      	@endforeach
									    </select>
								  	</div>
								</div>
								<div class="form-group">
								  	...
								  	<div class="col-md-10">								  	
								  		<input type="file" id="Product_Img" name="ProductImg" class="form-control input-md">
								  	</div>
								</div>
								<div class="form-group">
